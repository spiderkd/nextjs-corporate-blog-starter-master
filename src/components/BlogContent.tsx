...
import { ColorText } from "./WispComponents/colorText";
import { Quote } from "./WispComponents/qoute";
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-8 px-4 max-w-6xl">
        ...
        <div className="flex">
          <div className="lg:w-3/4 prose prose-lg max-w-none w-full break-words blog-content dark:prose-invert ">
            <Accordion
              type="single"
              collapsible
